...
addTooltip(
  session,
  id = "uptake_equalprob_checkbox_sc9",
...
addTooltip(
  session,
  id = "serial_ensemble_checkbox_sc9",
...
addTooltip(
  session,
  id = "parallel_ensemble_checkbox_sc9",
...
addTooltip(
  session,
  id = "parallel_ensemble_slider_sc9",
...
addTooltip(
  session,
  id = "ignore_cholesterol_checkbox_sc9",
...
addTooltip(
  session,
  id = "structural_alcohol_slider_sc9",
