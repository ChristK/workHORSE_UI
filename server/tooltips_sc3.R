...
addTooltip(
  session,
  id = "frequency_eligibility_slider_sc3",
...
addTooltip(
  session,
  id = "invite_known_hypertensives_checkbox_sc3",
...
addTooltip(
  session,
  id = "invite_known_diabetics_checkbox_sc3",
...
addTooltip(
  session,
  id = "cancel_program_checkbox_sc3",
...
addTooltip(
  session,
  id = "coverage_detailed_checkbox_sc3",
...
addTooltip(
  session,
  id = "uptake_detailed_checkbox_sc3",
  title = "Reveals advanced more granular inputs",
  trigger = "hover",
  options = list(delay = list(show = show_val, hide = hide_val))
)
...
addTooltip(
  session,
  id = "uptake_equalprob_checkbox_sc3",
...
output$uptake_table_help_sc3 <- renderUI({
  helpText(
    p(
...
output$statin_px_table_help_sc3 <- renderUI({
  helpText(
    p(
...
output$antihtn_px_table_help_sc3 <- renderUI({
  helpText(
    p(
...
addTooltip(
  session,
  id = "serial_ensemble_checkbox_sc3",
...
addTooltip(
  session,
  id = "parallel_ensemble_checkbox_sc3",
...
addTooltip(
  session,
  id = "parallel_ensemble_slider_sc3",
...
addTooltip(
  session,
  id = "ignore_cholesterol_checkbox_sc3",
...
addTooltip(
  session,
  id = "structural_alcohol_slider_sc3",
